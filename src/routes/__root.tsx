...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A bold travel portfolio. Capture every destination, post, and adventure in one place." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Wanderlog — Your travels, beautifully told" },
      { name: "twitter:description", content: "A bold travel portfolio. Capture every destination, post, and adventure in one place." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/94292e13-1fc6-4f61-a0e1-0dc7e7db9c6b/id-preview-4aa81070--76994fa1-8907-45e0-8eb1-3018755b200a.lovable.app-1776531743661.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/94292e13-1fc6-4f61-a0e1-0dc7e7db9c6b/id-preview-4aa81070--76994fa1-8907-45e0-8eb1-3018755b200a.lovable.app-1776531743661.png" },
    ],
    links: [
